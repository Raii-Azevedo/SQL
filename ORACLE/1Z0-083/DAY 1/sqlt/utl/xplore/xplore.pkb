...
/* $Header: xplore/xplore.pkb 19.1.200627 October 4th,2017 Stelios.Charalambides@oracle.com carlos.sierra mauro.pagano $ */
   ...
   * ------------------------- */
  TOOL_VERSION         CONSTANT VARCHAR2(32)  := '19.1.200627';
...
--         AND child_number = 0 -- 170908 often fails with ORA-01403: no data found 
         AND rownum = 1 --Avoid "ORA-01422: exact fetch returns more than requested number of rows" error. 
