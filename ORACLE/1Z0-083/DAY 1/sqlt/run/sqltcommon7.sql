REM $Header: 215187.1 sqltcommon7.sql 12.1.12 2015/09/11 stelios.charalambides@oracle.com carlos.sierra abel.macias $ 
-- begin common
...
HOS ls -r $ORACLE_HOME/cfgtoollogs/opatch/opatch*.log | head -n 1 | zip -j ^^unique_id._opatch -@
--
SET TERM ON;
