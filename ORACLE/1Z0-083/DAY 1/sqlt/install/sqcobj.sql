...
REM
REM $Header: 215187.1 sqcobj.sql 12.2.171004  October 4th, 2017 stelios.charalambides@oracle.com carlos.sierra mauro.pagano abel.macias $ 
REM
...
-- C = Char, N = Number
-- scharala - 25.08.2021 - Increased the size of "value" in sqli$_parameter to take account of very long connect strings.
ALTER TABLE &&tool_repository_schema..sqli$_parameter ADD (type CHAR(1));
ALTER TABLE &&tool_repository_schema..sqli$_parameter ADD (value VARCHAR2(150));
...
/* --- Casey Carstens e-mail from the 3rd of December 2020. Change target to VARCHAR2(256) from 64 ---*/

ALTER TABLE &&tool_repository_schema..sqlt$_dba_optstat_operations ADD (operation  VARCHAR2(64));
ALTER TABLE &&tool_repository_schema..sqlt$_dba_optstat_operations ADD (target     VARCHAR2(256));
